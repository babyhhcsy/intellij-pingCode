...
import com.pingCode.exceptions.PingCodeFormUrlEncodedException
import com.pingCode.exceptions.PingCodeJsonException
 ...
 */
object PingCodeApiContentHelper {
  ...
  @Throws(PingCodeJsonException::class)
  ...
  fun <T> fromJson(string: String, clazz: Class<T>, gqlNaming: Boolean = false): T {
    try {
      ...
      throw PingCodeJsonException("Can't parse Gitee response", e)
    }
  ...
  fun toJson(content: Any, gqlNaming: Boolean = false): String {
    try {
      ...
      throw PingCodeJsonException("Can't serialize Gitee request body", e)
    }
  }

  // for Gitee
  @JvmStatic
  @Throws(PingCodeFormUrlEncodedException::class)
