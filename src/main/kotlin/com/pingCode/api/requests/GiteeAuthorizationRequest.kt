 ...
 */
package com.pingCode.api.requests
...
data class AuthorizationCreateRequest(private val scope: String,
                                      ...
                                      private val clientId: String? = PCAccountsUtils.APP_CLIENT_ID,
                                      private val clientSecret: String? = PCAccountsUtils.APP_CLIENT_SECRET) : GiteeAuthorizationRequest() {
