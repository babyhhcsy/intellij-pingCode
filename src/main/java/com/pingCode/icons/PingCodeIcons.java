 ...
 * @author Yuyou Chow
 */
public final class PingCodeIcons {
  private static @NotNull Icon load(@NotNull String path) {
    return IconLoader.getIcon(path, PingCodeIcons.class);
  }
  ...
  public static final Icon pingCode_Add_Bug_icon = load("icon/createbug_Line_icons.svg");
