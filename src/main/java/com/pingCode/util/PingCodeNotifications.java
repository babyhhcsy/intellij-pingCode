...
import com.pingCode.exceptions.PingCodeOperationCanceledException;
import org.jetbrains.annotations.NonNls;
import org.jetbrains.annotations.NotNull;
import org.jetbrains.annotations.Nullable;

import static com.pingCode.util.PingCodeUtil.getErrorTextFromException;
 ...
 */
public class PingCodeNotifications {
  private static final Logger LOG = PingCodeUtil.LOG;

  private static boolean isOperationCanceled(@NotNull Throwable e) {
    return e instanceof PingCodeOperationCanceledException ||
  ...
  public static AnAction getConfigureAction(@NotNull Project project) {
    return NotificationAction.createSimple(
        "Configure...",
        () -> ShowSettingsUtil.getInstance().showSettingsDialog(project, PingCodeUtil.SERVICE_DISPLAY_NAME)
    );
  }
